...
const Quiz = () => {
  ...
  return (
    <section className="max-w-5xl mx-auto font-pixel text-white">
      {/* Quiz title */}
      <p className="text-lg mb-6 text-center text-yellow-300">
        How well do you know your girlfriend?
      </p>

      <div className="p-6 border-4 border-white bg-black">
        ...
        {!finished ? (
          <div>
            ...
            {/* Question box */}
            <div className="p-4 bg-black rounded-md shadow-inner mb-4">
              ...
              <div className="flex flex-col gap-3">
                {quizQuestions[index].options.map((opt, i) => (
                  <label
                    key={i}
                    className={`flex items-center gap-3 p-3 cursor-pointer transition-all duration-200 rounded-md shadow-sm
                      ${selected === i
